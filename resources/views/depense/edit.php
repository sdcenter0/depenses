...
<div class="container mt-3">
  ...
  <form action="<?= url("/depense/update/$depense->id") ?>"
        method="post">
    ...
    <div class="mb-3">
      ...
      <select id="supplier"
        ...
        <?php foreach ($suppliers as $supplier): ?>
          <option <?php if (old('supplier', $depense->supplier_id) === $supplier->id): ?>
                    selected
                  <?php endif; ?>
    ...
    <div class="mb-3">
      ...
      <input type="date"
             name="depense_date"
             value="<?= old('depense_date', $depense->depense_date) ?>"
    ...
    <div class="mb-3">
      ...
      <input type="text"
             name="invoice"
             value="<?= old('invoice', $depense->invoice) ?>"
    ...
    <div class="mb-3">
      ...
      <input type="text"
             name="nature"
             value="<?= old('nature', $depense->nature) ?>"
